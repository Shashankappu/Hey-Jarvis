...
public class ChatRVAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (chatsModal.getSender()){
            case "user": ((UserViewHolder)holder).UserTV.setText(chatsModal.getMessage());
            break;
            case "bot": ((BotViewHolder)holder).BotTV.setText(chatsModal.getMessage());
            break;
        }
    }
    ...
    public static class UserViewHolder extends RecyclerView.ViewHolder{
        ...
        public UserViewHolder(@NonNull View itemView) {
            super(itemView);
            UserTV = itemView.findViewById(R.id.usermsg_txtview);
        }
    }
    public static class  BotViewHolder extends RecyclerView.ViewHolder{
        ...
        public BotViewHolder(@NonNull View itemView) {
            super(itemView);
            BotTV = itemView.findViewById(R.id.botmsg_txtview);
        }
    }
}
